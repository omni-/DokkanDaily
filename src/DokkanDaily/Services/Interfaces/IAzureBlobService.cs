...
namespace DokkanDaily.Services.Interfaces
{
    public interface IAzureBlobService
    {
        ...
        Task<BlobClient> UploadToAzureAsync(string fileName, string contentType, IBrowserFile browserFile, Challenge challengeModel, string bucket = null, string userAgent = null, string discordUsername = null, string discordId = null, string remoteIp = null);
